...
product1 = Product(name="Handwoven Wool Rug", description="Traditional handwoven wool rug with geometric patterns", price=200, picture="../static/images/popular-1.jpg", artisan_id=artisan1.id, craft_id=craft6.id)
product1.save()

product2 = Product(name="Hand-painted Ceramic Tile", description="Handcrafted ceramic tile painted with intricate floral motifs", picture="../static/images/popular-1.jpg", price=15, artisan_id=artisan1.id, craft_id=craft9.id)
product2.save()

# Products for Artisan 2 (Fatima Ahmed) - Crafts: Woodwork, Rugs
product3 = Product(name="Hand-carved Wooden Bowl", description="Beautifully hand-carved wooden bowl made from sustainable teak wood", price=50, picture="../static/images/popular-1.jpg", artisan_id=artisan2.id, craft_id=craft1.id)
product3.save()

# Products for Artisan 3 (Mohammed Khalil) - Crafts: Ceramics, Engraving, Leatherworking
product4 = Product(name="Handcrafted Ceramic Vase", description="Elegant handcrafted ceramic vase with intricate blue glaze", price=80, picture="../static/images/popular-1.jpg", artisan_id=artisan3.id, craft_id=craft2.id)
product4.save()

product5 = Product(name="Tea Cups", description="A beautiful set of handmade tea cups", price=40, artisan_id=artisan3.id, picture="../static/images/popular-1.jpg", craft_id=craft13.id)
product5.save()

product6 = Product(name="Hand-tooled Leather Belt", description="Stylish hand-tooled leather belt with floral patterns", price=60, picture="../static/images/popular-1.jpg", artisan_id=artisan3.id, craft_id=craft7.id)
product6.save()

# Products for Artisan 4 (Layla Abbas) - Crafts: Jewelry, Metalwork
product7 = Product(name="Sterling Silver Pendant Necklace", description="Elegant sterling silver pendant necklace with natural gemstone", price=120, picture="../static/images/popular-1.jpg", artisan_id=artisan4.id, craft_id=craft3.id)
product7.save()

product8 = Product(name="Hand-forged Iron Candle Holder", description="Hand-forged iron candle holder with intricate scrollwork", price=80, picture="../static/images/popular-1.jpg", artisan_id=artisan4.id, craft_id=craft4.id)
product8.save()

# Products for Artisan 5 (Hassan Ibrahim) - Crafts: Glass, Basketry, Painting
product9 = Product(name="Stained Glass Window Panel", description="Colorful stained glass window panel with floral design", price=180, picture="../static/images/popular-1.jpg", artisan_id=artisan5.id, craft_id=craft5.id)
product9.save()

product10 = Product(name="Handwoven Seagrass Basket", description="Handwoven seagrass basket with lid, perfect for storage", price=50, picture="../static/images/popular-1.jpg", artisan_id=artisan5.id, craft_id=craft8.id)
product10.save()

# Products for Artisan 6 (Aisha Kareem) - Crafts: Sculpting, Painting, Calligraphy
product11 = Product(name="Hand-carved Stone Sculpture", description="Intricately hand-carved stone sculpture of a lion", price=300, picture="../static/images/popular-1.jpg", artisan_id=artisan6.id, craft_id=craft10.id)
product11.save()

product12 = Product(name="Islamic Calligraphy Art", description="Elegant Islamic calligraphy artwork with gold leaf accents", price=150, picture="../static/images/popular-1.jpg", artisan_id=artisan6.id, craft_id=craft12.id)
product12.save()

# Products for Artisan 7 (Youssef Nasser) - Crafts: Engraving, Leatherworking
product13 = Product(name="Hand-engraved Metal Flask", description="Custom hand-engraved stainless steel flask with intricate design", price=50, picture="../static/images/popular-1.jpg", artisan_id=artisan7.id, craft_id=craft14.id)
product13.save()

product14 = Product(name="Handwoven Cotton Hammock", description="Comfortable handwoven cotton hammock with fringe detailing", price=35, picture="../static/images/popular-1.jpg", artisan_id=artisan7.id, craft_id=craft15.id)
product14.save()

# Products for Artisan 8 (Nadia khalfaoui) - Crafts: Weaving, Furniture
product15 = Product(name="Handcrafted Leather Journal", description="High-quality handcrafted leather journal with embossed cover", price=120, picture="../static/images/popular-1.jpg", artisan_id=artisan8.id, craft_id=craft16.id)
product15.save()

product16 = Product(name="Persian Rug", description="Beautiful Persian that adds warmth in your house charm", price=250, picture="../static/images/popular-1.jpg", artisan_id=artisan8.id, craft_id=craft17.id)
product16.save()

# Products for Artisan 9 (Khaled Farouk) - Crafts: Woodwork
product17 = Product(name="Hand-carved Wooden Serving Tray", description="Elegant hand-carved wooden serving tray with intricate floral design", price=40, picture="../static/images/popular-1.jpg", artisan_id=artisan9.id, craft_id=craft1.id)
product17.save()

# Products for Artisan 10 (Sara Mansour) - Crafts: Woodwork, Calligraphy
product18 = Product(name="Hand-carved Wooden Jewelry Box", description="Exquisite hand-carved wooden jewelry box with floral motifs", price=60, picture="../static/images/popular-1.jpg", artisan_id=artisan10.id, craft_id=craft1.id)
product18.save()

product19 = Product(name="Custom Arabic Calligraphy Canvas", description="Personalized Arabic calligraphy canvas with name or phrase of choice", price=80, picture="../static/images/popular-1.jpg", artisan_id=artisan10.id, craft_id=craft12.id)
product19.save()

# Products for Artisan 11 (Ahmed Taha) - Crafts: Woodwork, Leatherworking
product20 = Product(name="Handcrafted Wooden Serving Platter", description="Beautiful handcrafted wooden serving platter with natural wood grain", price=50, picture="../static/images/popular-1.jpg", artisan_id=artisan11.id, craft_id=craft1.id)
product20.save()

product21 = Product(name="Hand-tooled Leather Keychain", description="Stylish hand-tooled leather keychain with durable metal hardware", price=20, picture="../static/images/popular-1.jpg", artisan_id=artisan11.id, craft_id=craft7.id)
product21.save()
